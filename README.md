# Entertainment — `oriz-blog-entertainment`

> Watch, listen, read — reviews and takes across film, TV, and music.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-entertainment?style=flat)](https://github.com/chirag127/oriz-blog-entertainment/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-entertainment)](https://github.com/chirag127/oriz-blog-entertainment/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-entertainment/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-entertainment/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Entertainment** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
An entertainment blog covering film, TV, music, and streaming — reviews and cultural takes with a point of view.

- **Live site:** https://entertainment-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-entertainment
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-entertainment/ — the canonical, always-current site is **https://entertainment-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-entertainment/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>entertainment-blog.oriz.in"]
...
```
oriz-blog-entertainment/
├── src/
│   ├── content/blog/       # the entertainment reviews (MDX/Markdown)
